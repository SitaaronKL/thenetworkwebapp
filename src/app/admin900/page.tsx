          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-100">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">AB Marketing Campaign Analytics with Discord Tracking</p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    <p className="text-xs text-gray-500 uppercase tracking-wider">Total Discord Clicks</p>
                    <p className="text-2xl font-bold text-indigo-600">{data.totalDiscordClicks || 0}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <table className="w-full text-left whitespace-nowrap">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider text-right">Discord Clicks</th>
                    <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider text-right">Conversion</th>
                    <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100 bg-white">
                  {data.campaignAnalytics.map((campaign: any) => {
                    const conversionRate = campaign.discord_clicks > 0 
                      ? ((campaign.signup_count / campaign.discord_clicks) * 100).toFixed(1)
                      : '0.0';
                    return (
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-100">
              <p className="text-xs text-gray-500">
                <strong>Discord Link Format:</strong> thenetwork.live/discord/[campaign_code] (e.g., /discord/columbia-a)
              </p>
            </div>
          </div>
        )}
